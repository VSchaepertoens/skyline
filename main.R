...
#check that the two columns are the same # must be fixed
#sum(data$fractional_abundance_of_glycan_in_each_replicate == data_frac_abud$frac_abud)
...
#check that the two columns are identical #must be fixed
#sum(data$fractional_abudnace_charge_state_merged == data_charge_states$frac_abud_charge_states)
